...
#ifndef HDR_OPENFLOW_140_HPP
#define HDR_OPENFLOW_140_HPP

#define OFP_140_NS openflow_140

#include <string.h>
#include <openflow-common.hpp>
#include <util/FieldManager.hpp>

#define PROTO_TAG_OPENFLOW_VER "OFP 1.4"
...
namespace openflow_140 {
    static const guint16 gVersion = 0x05;
    ...
    private:
        ...
        void dissect_ofp_port_mod_prop(proto_tree* parent);
